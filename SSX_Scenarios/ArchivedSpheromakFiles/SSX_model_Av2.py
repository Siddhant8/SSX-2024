...
from spheromakv2 import spheromak_A
...
solver.stop_wall_time = 60*60*45
...
field_writes = solver.evaluator.add_file_handler('fields10', max_writes=50, sim_dt=output_cadence, mode='overwrite')
...
load_writes = solver.evaluator.add_file_handler('load_data10', max_writes=50, sim_dt=output_cadence, mode='overwrite')
