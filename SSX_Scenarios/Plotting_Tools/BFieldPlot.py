# From https://github.com/jsoishi/SSX_project/blob/master/python/SSX_run.py
# Would need to be rewritten in Dedalus 3, but I believe visualizes the initialized B fields?
# So good template if attempting to do that.
